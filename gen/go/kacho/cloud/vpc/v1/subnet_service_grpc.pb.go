...
const (
	SubnetService_Get_FullMethodName               = "/kacho.cloud.vpc.v1.SubnetService/Get"
	SubnetService_List_FullMethodName              = "/kacho.cloud.vpc.v1.SubnetService/List"
	SubnetService_Create_FullMethodName            = "/kacho.cloud.vpc.v1.SubnetService/Create"
	SubnetService_Update_FullMethodName            = "/kacho.cloud.vpc.v1.SubnetService/Update"
	SubnetService_AddCidrBlocks_FullMethodName     = "/kacho.cloud.vpc.v1.SubnetService/AddCidrBlocks"
	SubnetService_RemoveCidrBlocks_FullMethodName  = "/kacho.cloud.vpc.v1.SubnetService/RemoveCidrBlocks"
	SubnetService_Delete_FullMethodName            = "/kacho.cloud.vpc.v1.SubnetService/Delete"
	SubnetService_ListOperations_FullMethodName    = "/kacho.cloud.vpc.v1.SubnetService/ListOperations"
	SubnetService_ListUsedAddresses_FullMethodName = "/kacho.cloud.vpc.v1.SubnetService/ListUsedAddresses"
)
...
var SubnetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kacho.cloud.vpc.v1.SubnetService",
	...
	Metadata: "kacho/cloud/vpc/v1/subnet_service.proto",
}
