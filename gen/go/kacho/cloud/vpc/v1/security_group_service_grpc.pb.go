...
const (
	SecurityGroupService_Get_FullMethodName            = "/kacho.cloud.vpc.v1.SecurityGroupService/Get"
	SecurityGroupService_List_FullMethodName           = "/kacho.cloud.vpc.v1.SecurityGroupService/List"
	SecurityGroupService_Create_FullMethodName         = "/kacho.cloud.vpc.v1.SecurityGroupService/Create"
	SecurityGroupService_Update_FullMethodName         = "/kacho.cloud.vpc.v1.SecurityGroupService/Update"
	SecurityGroupService_UpdateRules_FullMethodName    = "/kacho.cloud.vpc.v1.SecurityGroupService/UpdateRules"
	SecurityGroupService_UpdateRule_FullMethodName     = "/kacho.cloud.vpc.v1.SecurityGroupService/UpdateRule"
	SecurityGroupService_Delete_FullMethodName         = "/kacho.cloud.vpc.v1.SecurityGroupService/Delete"
	SecurityGroupService_ListOperations_FullMethodName = "/kacho.cloud.vpc.v1.SecurityGroupService/ListOperations"
)
...
var SecurityGroupService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kacho.cloud.vpc.v1.SecurityGroupService",
	...
	Metadata: "kacho/cloud/vpc/v1/security_group_service.proto",
}
